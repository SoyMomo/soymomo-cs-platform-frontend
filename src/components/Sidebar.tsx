...
export default function Sidebar() {
    return (
        <div className="fixed w-20 lg:w-60 h-screen p-4 flex flex-col">
            <div className="flex flex-col items-center h-full">
                <div className="flex flex-col w-44 h-5/6">
                    ...
                    <p className="text-sm font-semibold hidden lg:flex">Gustavo Lopez</p>
                    <p className="font-semibold mt-10 mb-4 hidden lg:flex">Categorías</p>

                    <Link href="/dashboard">
                        <div className="flex flex-row items-center justify-center lg:justify-start my-10 lg:my-4 hover:bg-white hover:text-[#603BB0] hover:rounded-xl hover:p-2">
                    ...
                    <Link href="/dashboard">
                        <div className="flex flex-row items-center justify-center lg:justify-start my-4 hover:bg-white hover:text-[#603BB0] hover:rounded-xl hover:p-2">
                ...
                <div className="bg-[#8A66DA] text-white rounded-xl w-20 lg:w-44">
